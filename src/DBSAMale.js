...
const colRef = collection(db, 'DBSAMale.Residence');
...
allocate.addEventListener('click', (e) => {
    ...
    const roomDocRef = doc(db, 'DBSAMale.Residence', 'roomNo');
    const roomDocRef2 = doc(db, 'DBSAMale.Residence', 'roomNo2');
    const roomDocRef3 = doc(db, 'DBSAMale.Residence', 'roomNo3');
    const roomDocRef4 = doc(db, 'DBSAMale.Residence', 'roomNo4');
    const roomDocRef5 = doc(db, 'DBSAMale.Residence', 'roomNo5');
    const roomDocRef6 = doc(db, 'DBSAMale.Residence', 'roomNo6');
    const roomDocRef7 = doc(db, 'DBSAMale.Residence', 'roomNo7');
    const roomDocRef8 = doc(db, 'DBSAMale.Residence', 'roomNo8');
    const roomDocRef9 = doc(db, 'DBSAMale.Residence', 'roomNo9');
    const roomDocRef10 = doc(db, 'DBSAMale.Residence', 'roomNo10');
    const roomDocRef11 = doc(db, 'DBSAMale.Residence', 'roomNo11');
    const roomDocRef12 = doc(db, 'DBSAMale.Residence', 'roomNo12');
    const roomDocRef13 = doc(db, 'DBSAMale.Residence', 'roomNo13');
    const roomDocRef14 = doc(db, 'DBSAMale.Residence', 'roomNo14');
    const roomDocRef15 = doc(db, 'DBSAMale.Residence', 'roomNo15');
    const roomDocRef16 = doc(db, 'DBSAMale.Residence', 'roomNo16');
    const roomDocRef17 = doc(db, 'DBSAMale.Residence', 'roomNo17');
    const roomDocRef18 = doc(db, 'DBSAMale.Residence', 'roomNo18');
    const roomDocRef19 = doc(db, 'DBSAMale.Residence', 'roomNo19');
    const roomDocRef20 = doc(db, 'DBSAMale.Residence', 'roomNo20');
    const roomDocRef21 = doc(db, 'DBSAMale.Residence', 'roomNo21');
    const roomDocRef22 = doc(db, 'DBSAMale.Residence', 'roomNo22');
    const roomDocRef23 = doc(db, 'DBSAMale.Residence', 'roomNo23');
    const roomDocRef24 = doc(db, 'DBSAMale.Residence', 'roomNo24');
    const roomDocRef25 = doc(db, 'DBSAMale.Residence', 'roomNo25');
    const roomDocRef26 = doc(db, 'DBSAMale.Residence', 'roomNo26');
    const roomDocRef27 = doc(db, 'DBSAMale.Residence', 'roomNo27');
    const roomDocRef28 = doc(db, 'DBSAMale.Residence', 'roomNo28');
    const roomDocRef29 = doc(db, 'DBSAMale.Residence', 'roomNo29');
    const roomDocRef30 = doc(db, 'DBSAMale.Residence', 'roomNo30');
    const roomDocRef31 = doc(db, 'DBSAMale.Residence', 'roomNo31');
    const roomDocRef32 = doc(db, 'DBSAMale.Residence', 'roomNo32');
    const roomDocRef33 = doc(db, 'DBSAMale.Residence', 'roomNo33');
    const roomDocRef34 = doc(db, 'DBSAMale.Residence', 'roomNo34');
    const roomDocRef35 = doc(db, 'DBSAMale.Residence', 'roomNo35');
    const roomDocRef36 = doc(db, 'DBSAMale.Residence', 'roomNo36');
    const roomDocRef37 = doc(db, 'DBSAMale.Residence', 'roomNo37');
    const roomDocRef38 = doc(db, 'DBSAMale.Residence', 'roomNo38');
    const roomDocRef39 = doc(db, 'DBSAMale.Residence', 'roomNo39');
    const roomDocRef40 = doc(db, 'DBSAMale.Residence', 'roomNo40');
    ...
    const docRef = doc(db, 'DBSAMale.Residence', 'roomNo');
    const docRef2 = doc(db, 'DBSAMale.Residence', 'roomNo2');
    const docRef3 = doc(db, 'DBSAMale.Residence', 'roomNo3');
    const docRef4 = doc(db, 'DBSAMale.Residence', 'roomNo4');
    const docRef5 = doc(db, 'DBSAMale.Residence', 'roomNo5');
    const docRef6 = doc(db, 'DBSAMale.Residence', 'roomNo6');
    const docRef7 = doc(db, 'DBSAMale.Residence', 'roomNo7');
    const docRef8 = doc(db, 'DBSAMale.Residence', 'roomNo8');
    const docRef9 = doc(db, 'DBSAMale.Residence', 'roomNo9');
    const docRef10 = doc(db, 'DBSAMale.Residence', 'roomNo10');
    const docRef11 = doc(db, 'DBSAMale.Residence', 'roomNo11');
    const docRef12 = doc(db, 'DBSAMale.Residence', 'roomNo12');
    const docRef13 = doc(db, 'DBSAMale.Residence', 'roomNo13');
    const docRef14 = doc(db, 'DBSAMale.Residence', 'roomNo14');
    const docRef15 = doc(db, 'DBSAMale.Residence', 'roomNo15');
    const docRef16 = doc(db, 'DBSAMale.Residence', 'roomNo16');
    const docRef17 = doc(db, 'DBSAMale.Residence', 'roomNo17');
    const docRef18 = doc(db, 'DBSAMale.Residence', 'roomNo18');
    const docRef19 = doc(db, 'DBSAMale.Residence', 'roomNo19');
    const docRef20 = doc(db, 'DBSAMale.Residence', 'roomNo20');
    const docRef21 = doc(db, 'DBSAMale.Residence', 'roomNo21');
    const docRef22 = doc(db, 'DBSAMale.Residence', 'roomNo22');
    const docRef23 = doc(db, 'DBSAMale.Residence', 'roomNo23');
    const docRef24 = doc(db, 'DBSAMale.Residence', 'roomNo24');
    const docRef25 = doc(db, 'DBSAMale.Residence', 'roomNo25');
    const docRef26 = doc(db, 'DBSAMale.Residence', 'roomNo26');
    const docRef27 = doc(db, 'DBSAMale.Residence', 'roomNo27');
    const docRef28 = doc(db, 'DBSAMale.Residence', 'roomNo28');
    const docRef29 = doc(db, 'DBSAMale.Residence', 'roomNo29');
    const docRef30 = doc(db, 'DBSAMale.Residence', 'roomNo30');
    const docRef31 = doc(db, 'DBSAMale.Residence', 'roomNo31');
    const docRef32 = doc(db, 'DBSAMale.Residence', 'roomNo32');
    const docRef33 = doc(db, 'DBSAMale.Residence', 'roomNo33');
    const docRef34 = doc(db, 'DBSAMale.Residence', 'roomNo34');
    const docRef35 = doc(db, 'DBSAMale.Residence', 'roomNo35');
    const docRef36 = doc(db, 'DBSAMale.Residence', 'roomNo36');
    const docRef37 = doc(db, 'DBSAMale.Residence', 'roomNo37');
    const docRef38 = doc(db, 'DBSAMale.Residence', 'roomNo38');
    const docRef39 = doc(db, 'DBSAMale.Residence', 'roomNo39');
    const docRef40 = doc(db, 'DBSAMale.Residence', 'roomNo40');
