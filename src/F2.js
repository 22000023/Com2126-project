...
const colRef = collection(db, 'F2.Residence');
...
allocate.addEventListener('click', (e) => {
    ...
    const roomDocRef = doc(db, 'F2.Residence', 'roomNo');
    const roomDocRef2 = doc(db, 'F2.Residence', 'roomNo2');
    const roomDocRef3 = doc(db, 'F2.Residence', 'roomNo3');
    const roomDocRef4 = doc(db, 'F2.Residence', 'roomNo4');
    const roomDocRef5 = doc(db, 'F2.Residence', 'roomNo5');
    const roomDocRef6 = doc(db, 'F2.Residence', 'roomNo6');
    const roomDocRef7 = doc(db, 'F2.Residence', 'roomNo7');
    const roomDocRef8 = doc(db, 'F2.Residence', 'roomNo8');
    const roomDocRef9 = doc(db, 'F2.Residence', 'roomNo9');
    const roomDocRef10 = doc(db, 'F2.Residence', 'roomNo10');
    const roomDocRef11 = doc(db, 'F2.Residence', 'roomNo11');
    const roomDocRef12 = doc(db, 'F2.Residence', 'roomNo12');
    const roomDocRef13 = doc(db, 'F2.Residence', 'roomNo13');
    const roomDocRef14 = doc(db, 'F2.Residence', 'roomNo14');
    const roomDocRef15 = doc(db, 'F2.Residence', 'roomNo15');
    const roomDocRef16 = doc(db, 'F2.Residence', 'roomNo16');
    const roomDocRef17 = doc(db, 'F2.Residence', 'roomNo17');
    const roomDocRef18 = doc(db, 'F2.Residence', 'roomNo18');
    const roomDocRef19 = doc(db, 'F2.Residence', 'roomNo19');
    const roomDocRef20 = doc(db, 'F2.Residence', 'roomNo20');
...
const docRef = doc(db, 'F2.Residence', 'roomNo');
const docRef2 = doc(db, 'F2.Residence', 'roomNo2');
const docRef3 = doc(db, 'F2.Residence', 'roomNo3');
const docRef4 = doc(db, 'F2.Residence', 'roomNo4');
const docRef5 = doc(db, 'F2.Residence', 'roomNo5');
const docRef6 = doc(db, 'F2.Residence', 'roomNo6');
const docRef7 = doc(db, 'F2.Residence', 'roomNo7');
const docRef8 = doc(db, 'F2.Residence', 'roomNo8');
const docRef9 = doc(db, 'F2.Residence', 'roomNo9');
const docRef10 = doc(db, 'F2.Residence', 'roomNo10');
const docRef11 = doc(db, 'F2.Residence', 'roomNo11');
const docRef12 = doc(db, 'F2.Residence', 'roomNo12');
const docRef13 = doc(db, 'F2.Residence', 'roomNo13');
const docRef14 = doc(db, 'F2.Residence', 'roomNo14');
const docRef15 = doc(db, 'F2.Residence', 'roomNo15');
const docRef16 = doc(db, 'F2.Residence', 'roomNo16');
const docRef17 = doc(db, 'F2.Residence', 'roomNo17');
const docRef18 = doc(db, 'F2.Residence', 'roomNo18');
const docRef19 = doc(db, 'F2.Residence', 'roomNo19');
const docRef20 = doc(db, 'F2.Residence', 'roomNo20');
